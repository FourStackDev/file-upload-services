...
public class FileUploadExceptionHandler extends ResponseEntityExceptionHandler {
	 ...
	 * <p>
	 * Whenever the DatabaseConstraintViolationException occurred, then ErrorResponse will
	 * be generated by the below method and send back to the Requester
	 * </p>
	 * 
	 * @param exception Type of Exception handled
	...
	/**
	 * Exception Handler method to handle HttpResponseStatusException.
	 * <p>
	 * Whenever the HttpResponseStatusException occurred, then ErrorResponse will
	 * be generated by the below method and send back to the Requester
	 * </p>
	 * 
	 * @param exception Type of Exception handled
	...
	public ResponseEntity<ErrorResponse> handleErrorResponse(HttpResponseStatusException exception, WebRequest request) {
		ErrorResponse response = new ErrorResponse();
		response.setCustomErrorCode(CustomErrorCodesAndMsgs.BAD_REQUEST_CODE);
		response.setCustomErrorMsg(CustomErrorCodesAndMsgs.BAD_REQUEST_MSG);
		response.setCustomErrorDescription("The server could not understand the request due to invalid syntax");
